...
object WarpManager {
    private val file = File(EWarp.instance.dataFolder, "warps.json")
    ...
    fun load() {
        doWarnable("读取warp数据", null) {
            ...
            if (!file.exists()) EWarp.instance.saveResource("warps.json", false)
    ...
    fun save() {
        Bukkit.getScheduler().runTaskAsynchronously(EWarp.instance, fun() {
